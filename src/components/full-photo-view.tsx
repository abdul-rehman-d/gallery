...
export default async function FullPagePhotoView(props: { id: number }) {
  ...
  return (
    <div className="w-full max-w-full overflow-hidden h-full max-h-full flex flex-row gap-4 bg-black/90">
      <div className="flex justify-center items-center">
        <img src={image.url} className="object-contain" />
      </div>
      <div className="w-56 flex-shrink-0 flex flex-col border-l pl-2">
